...
for begin_end in years:
    ...
    filt_data = filter_by_year(oscar_data, begin, end)  # отфильтруйте таблицу по промежутку
    # < напишите код здесь >

    mean_score = column_mean(filt_data, 2)
    mean_length = column_mean(filt_data, 3)
    mean_ppm = column_mean(filt_data, 7)  # < напишите код здесь >
    mean_gross = column_mean(filt_data, 6)  # вычислите средние значения
    # < напишите код здесь >
